...
def get_args():
    ...
    # data
    parser.add_argument('--dataset_names1', type=str, default='TITAN_PIE')
    parser.add_argument('--test_dataset_names1', type=str, default='TITAN_PIE')
    ...
    parser.add_argument('--max_n_neighbor', type=int, default=20)
    ...
    parser.add_argument('--cls_eff1', type=float, default=1.)
    ...
    parser.add_argument('--mono_sem_eff', type=float, default=0.0)
    ...
    parser.add_argument('--mm_fusion_mode', type=str, default='no_fusion', 
                        help='avg/gaussian/no_fusion')
